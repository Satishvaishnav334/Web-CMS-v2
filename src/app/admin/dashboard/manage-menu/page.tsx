                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-3">
                                ...
                                <button
                                    onClick={addMenuItem}
                                    className="flex items-center gap-2 px-3 py-2 bg-[#364153] hover:bg-[#525b69] text-white rounded-lg transition-colors"
                                >
                                    <Plus size={16} />
                                    Add Item
                                </button>
                        ...
                        <div className="flex gap-3">
                            <button
                                onClick={saveMenu}
                                disabled={loading}
                                className="flex items-center gap-2 px-4 py-2 bg-[#364153] hover:bg-[#525b69] text-white rounded-lg  transition-colors disabled:opacity-50"
                            >
                                <Save size={16} />
